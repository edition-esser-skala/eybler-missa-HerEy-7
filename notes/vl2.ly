...
GloriaViolinoII = {
  \relative c' {
    ...
    d:
    e:
    fis8 fis d d \hA fis fis
    g2.:
    fis8( d e \hA fis g a) %25
    g2.:
    g2.:
    a8( a d, h' a g)
    e2.:
...
QuiTollisViolinoII = {
  \relative c' {
    ...
    e2:16\p fis:
    h:\cresc c:
    f4:\f f16 f e e dis dis a' a g\decresc g fis fis
    fis\p fis e e e4: e: dis: %130
    e16\f h h h h4: h: a:
    g2:\sf g16 g fis fis fis4:
    f2:\pp e4: es:
    d2: e:
    f: fis: %135
    e:\cresc eis:
    fis4:\f e16 e d d g4:\decresc fis16 fis e e
    d\f fis fis fis fis h h h g2:
    gis: fis:
    g:\sfp g: %140
    fis:\sfp fis:
    g: f:
    e4: fis2: gis4:
    cis,16 fis fis fis fis4: fis2:\pp
    fis4: e: e2: %145
    d: d:
    fis: g:
    c:\cresc c:
    ...
    d4: fis: g2:\p
    fis: f:
    d4:\sfp d16 d e f f f e e e4:
    f:\p f16 f e e dis4: e:
    e: dis: e4 h8 h %155
    c4 d c2
    h r\fermata \bar "||" %157 finis
  }
}
