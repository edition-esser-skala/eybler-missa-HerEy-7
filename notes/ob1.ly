...
EtIncarnatusOboeI = {
  \relative c' {
    ...
    d16 c b a a4 c8 a
    f4 \pd g8 a b a
    c8. a16 g8 \pa d'16_( c h c d e) \pd %90
    f2.\sfp
    \pa e4 r8 h16_( c cis d dis e) \pd
    f2.\sfp
    \pa e8 r r d16 c h c e c
    a8 a'4 g f8 %95
    r g4 f e8
    f,4 f'4. f8
    \pd f4 e r
...
EtResurrexitOboeI = {
  \relative c' {
    ...
    r2 \tempoEtMortuos r
    R1 %185
    r2\fermata \tempoCuiusRegni \pa g4\f g \pd
    g'2 e
    f d
    \pao c4 d e2
    d4 r \pa c2~  %190
    ...
    a,4 f c'2
    \pa r8 d4 e8 \pd f2
    e4 d\trill \pao c r\fermata \bar "|." %260 finis
  }
}
...
CredoOldOboeI = {
  \relative c' {
    ...
    \pao c2 e
    a g
    \pa f4~ f16 e d c h c d e f g a h \pd \noBreak %245
    c4 r r2\fermata
...
AgnusOboeI = {
  \relative c' {
    ...
    R1*9 %15
    r2 es~\fE
    es8\decresc des c! b f2~\p
    f4 r r2
    R1
    des'4.\f f8 f8. c16 c4 %20
    f4. \pa es16 d c8 h h d
    d as! g f f es es'4
    d8 c c b! \pd b as as g
    es' d d c c h r4
    r2 r8 \pa c'~\pE c16 g as e \noBreak %25
    g f as g \pd f es d c c4\trill h\fermata \bar "||"
