...
KyrieOrgano = {
  \relative c {
    ...
    \mvTr c4\p-\tuttiE r r \segnoMark 1
    c( d e)
    f4 r r
    d( e f)
    g r r %5
...
KyrieBassFigures = \figuremode {
  ...
  <6 5>4 \bo <6 [4]> \bc <7! [3]>
  r4. <3>8 q q
  <10 8>2 \bassFigureExtendersOn q8 q
  r2. %25
  q2 q8 q \bassFigureExtendersOff
  r2.
  r2 <6- 4 2>4
...
KyrieOldOrgano = {
  \relative c {
    ...
    f'!2.:8\ff
    b,4 r r
    \mvTr b4(\p-\senzaOrg c \once \stemUp des)
    es r r
    c( des es) %75
    f r r
    des( es f)
    ...
    fis:
    h,!4\f r r %80
    \mvTr h(\p-\senzaOrg cis \once \stemUp dis)
    e r r
    cis( dis e)
    fis r r
    dis( e fis) %85
...
KyrieOldBassFigures = \figuremode {
  r2.
  r
  r
  r
  ...
  <6> <7 [_+]> <5[!]>
  <6> <6 4> <[7] _+>
  r4. <8 3\!>8 \bassFigureExtendersOn q q
  q4. q8 q q
  <8 _!>4. <8 3\!>8 q q %40
  ...
  <5>4 <\t> <[6]>
  <6 5>4 <6 3> <7->
  r4. <5 3>8 <\t 3> <6! 4 3> %110
  <10 8>2 \bassFigureExtendersOn q8 q \bassFigureExtendersOff
  <5>4 <\t> <6>
  <6 5> <6 _!> <7>
  r4. <4 2>8 <6 4> <8 6>
  <10 8>2 \bassFigureExtendersOn q8 q \bassFigureExtendersOff %115
  <5>4 <\t> <6>
  <6 5> <6> <7->
  r2 <6>4
  <9> <6-> <6>
  ...
  <6 5>2 \bassFigureExtendersOn q8 q \bassFigureExtendersOff
  <9>4 <6> q
  <6 5>2 \bassFigureExtendersOn q8 q \bassFigureExtendersOff %145
  <10 9>4 \bassFigureExtendersOn <10 8>8 <10 7> <10 6> <10 5> \bassFigureExtendersOff
  <9 7>4 <8 6>8 <7> <6> <5>
  <9 7>4 <8 6>8 <7> <6> <5>
  <9 7>4 <8 6>8 <7> <6> <5>
  <9 7>4 <8 6>8 <7> <6> <5> %150
  <9 7>4 <8 6> <7 5>
  r2.
  r
  r
...
GloriaOrgano = {
  \relative c {
    ...
    d2: d,8 d
    g g-!\f a-! h-! c-! d-!
    e-! h-! c-! d-! e-! fis-! \segnoMark 1 %35
    g4 g\f << { c^\org } \\ { c,_\markup \remark "vlc, b" } >> \segnoMark 1
    g' r r
    r g << { c^\org } \\ { c,_\markup \remark "vlc, b" } >>
    g' r r
    r g c, %40
    g'8 h,\p h h h h
    r c c2:
    ...
    << {
      ...
      \mvTr d8\f-\markup \remark "vlc, b" d' cis, cis' c, c'
      h, h' e, e' cis, cis' %50
      d, d' d d d, d
    } >>
    g-\solo c h e d g
    ...
    g g' a g f! e %90
    d f g f e d
    \mvTr c\f-\tutti c'16 h c8 g e g
    c, c'16 h c8 g e c
    h h'16 a h8 d g, h
    c c16 h c8 g e c \segnoMark 3 %95
...
GloriaBassFigures = \figuremode {
  ...
  <6 3> <6 _+> <6 3\!> q q q \bassFigureExtendersOff
  <5 4> <6\\ 3> <8 3> <3> q q
  <6>2.
  r %30
  q2 q4
...
QuiTollisOrgano = {
  \relative c {
    ...
    \mvTr e8(\p-\soloE g e g) dis( fis \hA dis fis)
    d\cresc gis d \hA gis c, a' c, a'
    a,\f a' a, a' h, h' dis,\decresc dis'
    e,\p e' c, c' a, a' h,-\tuttiE h' %130
    e,4:16\f g: a2:
    ais: h:
    g4:\pp g: a: fis!:
    g: g,: c8(-\solo e c e)
    h( d h d) a( c a c) %135
    gis(\cresc h \hA gis h) g g' g, g'
    fis,\f fis' g, g' e\decresc cis fis-\tutti fis,
    h4:\f d: e2:
    eis: fis:
    e:\sfp e:-\solo %140
    d:\sfp^\tuttiE h:
    e: g:
    g4: fis!16 fis ais, ais h4: eis:
    fis2: \mvTrr d:\pp-\senzaOrg
    dis4: e: a,: c: %145
    d: d,: g8( h' g h)
    dis,( fis \hA dis fis) e( g e g)
    a,(\cresc c a c) d( a' d, a')
    fis d' \mvTr fis,\f-\tutti d' g,4: h:
    c: h: a: g: %150
    fis: d: g2:
    dis:\p d:
    h:\sfp c:
    ...
    h: << {
      ...
      e,2~_\markup \remark "org, b"_\tasto %155
      e1~
      e2
...
QuiTollisBassFigures = \figuremode {
  r2 <6> %127
  <4\+> <6>
  <6!>4 \once \bassFigureExtendersOn q8 <5> <9 7 _+> <\t \t> <6 4> <5 3>
  <9> <8> <3> <6> <6 5>4 <8 _+>8 <7 \t> %130
  r4 <6> <_ 9 6!> <_ 8 \t>
  <10+ 7 \t> <\t \t 5> <6 4>8 <[5\+] _+>4.
  <7!>2. <7->4
  <8 4> <\t 3>8. <7! \t>16 r2
  <6\\ 5!> <6\+ 4\+ _!> %135
  <6> <6\\>
  <6 _+>4 <6[!] 4\+ 3>8 <_ 5 \t> <6\\ 5>4 \bo <8 [5\+] _+>8 \bc <7 [\t] \t>
  r4 <6> <9\\ 6! _!> <8 \t \t>
  <7 \t _+> <\t 5 \t> <6 4>8 <5\+ _+>4.
  <6\\ 4\+ _!>1 %140
  <6>
  <7>4 <6!> <7! 4!> <\t 3>
  <[6\\] 4\+ 2\+> <6 4>8 <6 5 _+> <9\\ 4>4 <7 _+>
  <[5\+] _+>1
  r %145
  r
  <6>2 <6 5>
...
QuoniamViolone = {
  \relative c {
    ...
    f e d c g' g, r4 %175
    R1
    r4 \mvTr g'\pE-\pizz r c,
    R1
    r4 g' r c,
    r2 \clef "treble_8" \mvTr f4\f-\arco a8 c %180
    \clef bass a,4 c8 f a2~
    a4 g8 f e\p r e r
    gis r gis r a r a r
    d, r f r g r g r
    g, r g r c4 r %185
    r8 c'\fE c4\trill d8 d, d'4
    r8 d d4\trill e8 e, e'4
    r8 e e4\trill f8 f, e' e,
    d' d, g g, c e e4\trill
    c8 a a'4 r8 fis8 fis4\trill %190
    d8 h h'4 r8 g g4\trill
    e8 fis g2 f4
    e4 r r f8. e16
    d8. c16 h4 r g'8. f16
    e8. d16 c4 \clef "treble_8" a'8 h \clef bass a[ g] %195
    f e16 f g8 f e d c4
    \clef "treble_8" r c'8. h16 a8. g16 fis4
    r d'8. c16 h8. a16 g4
    r e' c d
    g,8 \noBeam \clef bass c c4\trill d8 d, d'4 %200
    r8 d d4\trill e8 e, e'4
    r8 e e4\trill f8 f, e' e,
    d d' d4\trill c,8 c' c4\trill
    h,8 h' h4\trill a,8 a' f4\trill
    d8 h h4\trill g8 g' g4\trill %205
    e8 c c4\trill a8 a' a4\trill
    f8 g a2 g4~
    g8 c, f2 e4~
    e8 a, d2 cis4
    d \clef "treble_8" b' g \clef bass g8. f16 %210
    e8. d16 c4 r a'8. g16
    f8. e16 d4 r b'8 a
    g f16 g a8 g f d g f
    es d16 \hA es f8 \hA es d c b4
    \clef "treble_8" r4 b'8. a16 g8. f16 e4 %215
    r c'8. b16 a8. g16 f4
    r d'8. c16 b8 \noBeam \clef bass g g4\trill
    a8 a, a'4 r8 a a4\trill
    b8 b, \hA b'4 r8 \hA b b4\trill
    c8 c, b' b, a a' a4\trill %220
    b,8 b' g, g' es c c4\trill
    a'8 a, a'4\trill f8 d d4\trill
    b'8 b, \hA b'4\trill g8 e! e4\trill
    c'8 c, c'8. b16 a8. g16 f4
    r b8. a16 g8. f16 e!4 %225
    r a8. g16 f8. e16 d4~
    d e a, f'
    d8 h h4\trill g' g
    ...
    g g' g4\trill f,8 f' f4\trill %235
    e,8 e' e4\trill d,8 d' d4\trill
    e a8 g f e16 f g8 f
    e c f e d c16 d e8 d
    c a a'4 f8 d d4\trill
    h'8 h, h'4 g8 e e4\trill %240
    c'8 c, c'4 a8 h c4~
    c h4. e,8 a4~
    a g2 fis4
    <g g,>1
    ...
    a8 \noBeam \clef bass c c4\trill d8 d, d'4 %255
    r8 d d4\trill e8 e, e'4
    r8 e e4\trill f8 f, f'4
    r8 f f4\trill g8 g, c c,
    g' f g g, c4 g'
...
QuoniamOrgano = {
  \relative c {
    ...
    \key c \major \time 4/4 \tempoQuoniam
      \set Score.currentBarNumber = #158
    \partial 8 \mvTr g'8\f-\soloE-\unisono c8.\trill d16 e8 e, a8.\trill h16 c8 c,
    f e d c g' g, r a'
    d8.\trill e16 f8 f, b8.\trill c16 d8 d, %160
    g f e d a' a, r4
    ...
    d c h g c c'16 h c8 e,
    d c h g c c'16 h c8 e,
    f c' a f e g c e \segnoMark 4 %165
    d h c c, g g' d h
    g d'' h g c g e c
    h d' h g c g e c
    a a'16 g a8 g f e d16 c h a
    ...
    d8 d, d' c h d g, c
    f, d g g, c4 r
    r2 r4 r8 \mvTr g'\f-\solo-\unisonoE
    c8.\trill d16 e8 e, a8.\trill h16 c8 c,
    f e d c g' g, r4 %175
    \clef "treble_8" g'4-!\p c8-! e-! g2-!
    \clef bass g,4 r c, r
    \clef "treble_8" g'4 c8 e g2
    \clef bass g,4 r c, r
    \clef treble \mvTr c'4\f-\tuttiE f8 a \clef "treble_8" f,4 a8 c %180
    \clef bass a,4 c8 f a2~
    a4 g8 f e\p r e r
    gis r gis r a r a r
    d, r f r g r g r
    g, r g r c4 r %185
    r8 c-!\fE c-! c-! d8.-! d16-! d8-! r
    r d-! d-! d16-! d-! e4-! e-!
    r8 e-! e-! e16-! e-! f4-! e-!
    d2\trill << {
      r8 g g g
    ...
    d8. c16 h4 r g'8. f16
    e8. d16 c4 \clef "treble_8" << { f' } \\ { a,8[ h] } >> \clef bass a g %195
    f e16 f g8 f e d c4
    \clef "treble_8" r c'8. h16 a8. g16 fis4
    r d'8. c16 h8. a16 g4
    \clef treble << { c' } \\ { e,8[ fis] } >> \clef "treble_8" e4 c d
    \clef bass r8 c, c c d8. d16 d4 %200
    r8 d d d16 d e4 e
    r8 e e e16 e f4 e
    d2 c
    h a4 f'
    ...
    \clef "treble_8" r4 b'8. a16 g8. f16 e4 %215
    r c'8. b16 a8. g16 f4
    \clef treble << { b' <f a> <f g>8 } \\ { d8 e d c b } >> \clef bass g,[ g g]
    a8. a16 a4 r8 a a a16 a
    b4 b r8 \hA b b b16 b
    c4 b a2 %220
    b4 g' es c
    a' a f d
    b' b g e!
    c' c8. b16 a8. g16 f4
    r b8. a16 g8. f16 e!4 %225
    r a8. g16 f8. e16 d4~ \segnoMark 5
    d e a, f' \segnoMark 5
    d h g' g
    e c a' \clef "treble_8" c
    d c2 h4 %230
    c \clef treble << { d'8 c b a16 b c8 b a } \\ { f2 e4 f8 } >>
    ...
    g~ %250
    g~
    g2~ g8 } >> \clef treble g''[ g g]
    << {
      a8. a16 a4 r8 a a a16 a %253
      h4 h r8
    } \\ {
      r8 c, c c d8. d16 d4 %253
      r8 d d d16 d e8
    } >> \clef "treble_8" g, g g
    a \clef bass c,[ c c] d8. d16 d4 %255
    r8 d d d16 d e4 e
    r8 e4 e8 f4 f
    r8 f4 f8 g4 c
    g2 c,4 g'
...
QuoniamBassFigures = \figuremode {
  ...
  q <5> <6 5>4 r4. <6>8
  r2 <6> %165
  r8 <6 5> <\t \t> <[5 3]> <6 4> <5 [3]>4.
  r1
  <[6]>
  <8 3>8 <\t _+> <4 2> <6 4\+> <6>4.. \once \bassFigureExtendersOn q16
  r4 <4[!] 2>8 <6 4> <6>2 %170
  <5>4. \bo <[6]>8 \bc q4 <7>
  <6> <6 4>8 <7 [3]> r2
  r1
  r
  ...
  r1
  <7>2 <9 4>4 \bc <[8 3]>
  r2 <5>4. \bassFigureExtendersOn q8 %180
  <6>1
  q4 \bassFigureExtendersOff <6 4>8 <5> <6>2
  <7>1
  r2 <6 4>4 <\t \t>
  <\t \t> <7 [3]>2. %185
  r1
  ...
  q1 %195
  \bo <[6 5]>2 \bc <[6 _]>
  <6>4.. \once \bassFigureExtendersOn q16 <6\\>2
  <6 _>4.. \once \bassFigureExtendersOn q16 <6>2
  r2 <[6 5]>4 <_!>
  <4>8 <\t> <6>4 <3>2 %200
  r8 <6>4. <3>2
  <6>4. \once \bassFigureExtendersOn q8 <3> <4> <6 4> <\t 3>
  <7>4 <6> <7> <6>
  <7> <6\\>2.
  <6>1 %205
  q
  ...
  <2>4 <6->8 <5> <2>4 <6>8 <5>
  r4 <3> <6> <6 _-> %210
  <6>2 q4.. \once \bassFigureExtendersOn q16
  q2. <5>4
  <6 5 [_-]>4 <3> <6 5> <_->
  <6 5[-]>2 <6->
  <6>4.. \bassFigureExtendersOn q16 \bo <6! [_-]>4.. \bc q16 %215
  <6>4.. q16 \bassFigureExtendersOff <6>2
  r2 r8 <7 _-> <6 \t>4
  <6>1
  r2. q4
  <5 _->8 <6 \t> <8 6> <_ 5> <7 5->4 <6 \t> %220
  r \bo <[_-]> <5-> \bc <[_-]>
  <5->1
  r2 <[_-]>4 <5->
  r2 <6>
  <10 5>4.. \once \bassFigureExtendersOn q16 <6! [_-]>2 %225
  <10 5!>4.. \once \bassFigureExtendersOn q16 <6>2
  <6!>4 <_+>2 <5>4
  <6>1
  q
  <5>8 <6> <8> <6> <2>4 \bo <[6]>8 \bc <[5]> %230
  r1
  r4 <6> <_->2
  <6 _->4.. \once \bassFigureExtendersOn q16 r2
  <6>4.. \once \bassFigureExtendersOn q16 <3>8 <4> <6>4
  <7 _-> <6 \t> <7> <6> %235
  <7> <6\\> <5 3>4. <6! \t>8
  <9 6>2 <[6 5]>
  <6>1
  ...
  r2 r8 <6 3>4.
  r8 <6>2.. %255
  <6>4.. \once \bassFigureExtendersOn q16 <5>2
  <6>4. \once \bassFigureExtendersOn q8 r2
  <6>8 \bassFigureExtendersOn <6 3> <6 4>4 \bassFigureExtendersOff <7>2
  <4>4 <3>2.
  r1 %260 finis
}
...
CredoBassFigures = \figuremode {
  ...
  r1
  <6>2 q
  <\fivehat> <7>4 <[8] 6 _+>8 <5 [3]> %55
  r2 <_+>
  <6> <6>4 \once \bassFigureExtendersOn q8 <5>
  <9 4>4 <8 3> <_+>2
  <5!> <6>4 \once \bassFigureExtendersOn q8 <7>
  <9 4>4 <8 3>2. %60
  <7>4 <6 4> <7> <6 4>
  <7> <6 4> <7> <6 4>
  <6>8 <8> <6 5> <8> <6 4 3>2 \bassFigureExtendersOn
...
EtIncarnatusOrgano = {
  \relative c {
    ...
    c4 c,8 r r4
    R2.*7 %89
    r4 r8 e(\p\cresc d c) %90
    h2.:16\sfp
    c:
    h:\sfp
    c4: c16 c e e d d c c
    f4: e: d: %95
    e: d: c:
    d: d16 d c c h h a a
    gis4: a16 a a' a a a g g
    f4: f16 f g g f f g g
    f f f e d4: c!: %100
    h: c2:
    f16 f d d g4: g,:
    e'2:\sfp f4:
    g2: f4:
    e2_\sfp f16 f d d %105
    g2: g,4:
    c2.:\pp
    c4: c16(-\unisonoE h c \hA h c \hA h c \hA h)
    c(\cresc h c d es f g as g f es d)
    \mvTr c(\f-\tutti h c d es f g as g f \hA es d) %110
    ...
    as,16 as' as as as4: as:
    as,16 as' as as as4: as:
    ges,16 ges' ges ges ges4: ges: %125
    ces,16 ces' ces ces ces4: ces:
    c,16 c' c c c4: c:
    g r r
    R2.*3 %131
    \mvTr g,2.~\p-\tasto
...
EtResurrexitOrgano = {
  \relative c {
    ...
    ais h \hA ais gis fis e d cis
    h ais h cis d h \hA cis d
    e d cis d e \hA cis d e
    fis e \hA fis gis ais \hA fis \hA gis ais
    h ais h c! h a g fis %145
    e dis e fis g e \hA fis g
    a g fis g a \hA fis g a
    h ais h cis dis h \hA cis \hA dis
    e h e, f! e d! c! h
    a gis a h c a h c %150
    d c h c d h c d
    e dis e fis gis e \hA fis \hA gis
    a gis a b a g? f e
    d cis d e f d e f
    g f e f g e f g %155
    ...
    e g e c h d h g
    a a' a, g fis a d fis
    g e c d g,4\f r8 g16-\unisono a
    ...
    c-!\sf d-! es-! d-! c-!\sf d-! \hA es-! d-!
    c-!\sf d-! es-! d-! c-!\sf d-! \hA es-! d-!
    c-! b-! as-! g-! \tempoEtMortuos f2\sfp-\senzaOrg
    as g %185
    g\fermata \tempoCuiusRegni \clef treble g''4\f^\org g
...
EtResurrexitBassFigures = \figuremode {
  ...
  <_-> <_!>
  r <[_-]>
  <_->2 \bassFigureExtendersOn q8 q \bassFigureExtendersOff <_->4 %220
  <[5-]>2. \bo <6- [_-]>8 \bc <5 [\t]>
  <7 5! _+>4 <_-> <5! 4> <\t _+>
  \bo <[_- _]>2 <6 _->4 <_+>
  <_->1
  <6>2 \bc <[6 _]> %225
  <\fivehatflat> <6 5>
  <_->2 \once \bassFigureExtendersOn q8 <_!> <5 4 2> <4!>
  <6>1
  <6 5->2.. <6\\ 4 3>8
  <_+>2 <_!> %230
  <6 5>2.. <6\\ 4 3>8
...
CredoOldOrgano = {
  \relative c {
    ...
    c4 c, r2\fermata
    \tempoMortuorum R1*4 \noBreak %250
    r2 r4\fermata \clef treble \tempoEtVitam g''\f
    \twofourtime \time 2/4 c8 \clef bass c,,[ d e] \noBreak
    f4. e8
    d d e f
    g4. f8 %255
    e e f g
    ...
    a4 \clef bass f!~
    f d %270
    \clef "treble_8" h' \clef bass g~
    g e
    \clef "treble_8" c' d8 e
    d2\trill
    c4 \clef bass c, %275
    g'2
    e4 e
    ...
    \clef "treble_8" h' \clef bass g~
    g e
    \clef "treble_8" c'8 h a g
    f e16 f g8 f %380
    e \clef bass c[ f e]
    d c16 d e8 d
    c \clef "treble_8" a'[ d c]
    h a16 h c8 h
    a4 \clef bass d, %385
    g2
    e4 e
...
CredoOldBassFigures = \figuremode {
  r2 <6> %239
  <5> <6> %240
  r \bo <[6 5]>
  r2. <6 5>4
  ...
  r4 <8>8 <7>
  <6>2
  <_+>4 <8 _+>8 \bassFigureExtendersOn <7 _+>
  <6 _+>4 \bassFigureExtendersOff <5\+>
  r2 %265
  <2>4 <\t>
  r2
  r
  ...
  <6>4 <7 3>8 <\t 3>
  <7>4 <6\\>
  r8 <10\! 8> \bassFigureExtendersOn q q \bassFigureExtendersOff
  r2
  <6\\> %285
  <5\+>
  <6>
  ...
  <6 4> <\t \t> %310
  <6 4> <\t \t>
  <8> \once \bassFigureExtendersOn q8 <5>
  ...
  <6>4 <\t>8 <5->
  r2
  <8 6>8 \bassFigureExtendersOn <8 5> <8 _-> <8 1> \bassFigureExtendersOff
  <7 _->4 <6 \t>
  <7> <6> %340
  <7> <6\\>
  r2
  ...
  r
  r %355
  <5 3\!>8 \bassFigureExtendersOn q q q \bassFigureExtendersOff
  \bo <[6 5]>2
  \bc <[6 _]>
  r4 <6>
  r2 %360
  ...
  r %365
  r
  <10>4 \once \bassFigureExtendersOn q8 <7>
  r2
  ...
  <6>
  r
  q4 \once \bassFigureExtendersOn q8 <7> %375
  <6>2
  q4 \once \bassFigureExtendersOn q8 <7>
  <6>2
  ...
  <6 5>2
  q8 <\t \t>4.
  <6 5>4 \bassFigureExtendersOn <6 3\!>8 q \bassFigureExtendersOff
  <7>4 <8 _+>8 <7 \t> %385
  r2
  <8 6>4 <\t \t>8 <7 5>
  r2
  ...
  <8 6>4 <\t \t>8 <7 5>
  r2 %405
  <8 6>8 \bassFigureExtendersOn <8 5> <8 3\!> q \bassFigureExtendersOff
  <7>4 <8>8 <7>
  <6 4>4 <\t \t>
  <6 4> \bassFigureExtendersOn q8 <6 7>
  <6\! 4\!>4 <6 4>8 <6 7> %410
  <6\! 4\!>4 <6 4>8 <6 7>
  <6\! 4\!>4 <6 4>8 <6 7> \bassFigureExtendersOff
  <6>4. <6 4>8
  <8 6>4. <\t 6>8
  <6\\>4 <6> %415
  <[6 5]> <_+>
  ...
  r4 <6>8 q
  r2 %440
  <8 3>4 \bassFigureExtendersOn <8 _->8 <8 3> \bassFigureExtendersOff
  <7 _->4 <6 \t>
  r4 <6->8 <5>
  <2>2
  r4 <6>8 <5> %445
...
SanctusOrgano = {
  \relative c {
    ...
    a, a'16 g a8 cis e \hA cis %15
    a a16 g a8 e cis a
    d d'16 cis d8-! a-! fis-! a-!
    d, d'16 cis d8 a fis a
    d, d16 cis d8 fis a \hA fis
    d d'16 cis d8 a fis d %20
    g g16 fis g8 d h d
    g, g'16 fis g8 g, g' f
    e c'16 h c8 g e c
    g g'16 fis g8 g, g' g,
    ...
    << { g_! \clef bass g, g g g g } \\ { r8 g g g g g } >>
    e4 c r %40
    r8 g' g g g g
...
SanctusBassFigures = \figuremode {
  ...
  <5>4 <6>8 q q <6 5>
  r4 <[6]> <6> %35
  q4. \once \bassFigureExtendersOn q8 q4
  q <4> <3>
  r2.
  r
  <[6]> %40
...
BenedictusOrgano = {
  \relative c {
    ...
    g,8 g' r4 %10
    r8 c,\sf c' c,
    r g' fis16(\decresc g a h)
    c\p r h r a r g r \segnoMark 1
    d8 d' r4
    r8 \mvTr h\fE-\tutti a g %15
    r fis a d,
    r e c a
    d d, d' r
    r c' a g
    ...
    g fis e d!
    cis e a g
    fis h g a \segnoMark 2 %45
    d,4 r
    r \mvTr a8\pE-\pizz a
    d4 r
    r \mvTr a'8\f-\arco a \segnoMark 3
    d,4 r8 fis-\soloE %50
    g g, r e'
    fis fis, r d'
    e e, r cis'
    ...
    fis a d, c
    h e c d \segnoMark 4
    g,4 \clef "treble_8" g'16(\pE h) h( d)
    d8^\critnote r \clef bass d,-\pizz d
    g4 r %95
    r \mvTr d8\f-\arco d
    g,4 r8 h'-\solo
    c c, r a'
...
BenedictusBassFigures = \figuremode {
  ...
  r <6\\>4 <6>8
  <6 5> <\t \t> <_+>4
  \bo <[6 _]>8 <8 6>16 \bc <[7 5]> <7> <6> <6 4> <5 _+> %45
  r2
  r
  r
  r
  ...
  r2
  r8 <6\\> <5> <6> %90
  <6 5>4 \once \bassFigureExtendersOn q8 <2>
  <6>4 <7>16 <6> <6 4> <5 3>
  r2
  r
  r %95
  ...
  r8 <6\\> <5> <6>
  <6 5>4 \once \bassFigureExtendersOn q8 <2>
  <6 4>16 <\t 3> <6> <5 _> <9 7> <8 6> <6 4> \bc <[5 3]> %110
  r2
  r
  r
  r
